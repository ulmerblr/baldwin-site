...
export const about = {
  meta: {
    ...
    description:
      'Chris Baldwin has spent 25+ years helping families in California and Texas protect their financial futures with life insurance and annuity solutions.',
  },
  ...
  licensing: {
    heading: 'Licensed and Serving California and Texas',
    body: 'Baldwin Insurance Agency serves families across California and Texas.',
    items: [
...
export const productsIndex = {
  meta: {
    ...
    description:
      'Explore life insurance, annuity, and retirement solutions from Baldwin Insurance Agency, serving families in California and Texas.',
  },
...
export const agentOpportunityPage = {
  meta: {
    ...
    description:
      'Join a team that invests in your success. Training, mentorship, and AI-powered lead tools for new and experienced agents in California and Texas.',
  },
  theWork: {
...
export const contact = {
  meta: {
    title: 'Contact Baldwin Insurance Agency | California & Texas',
    description:
...
export const homeAdditions = {
  ...
  serviceAreas: {
    heading: 'Serving Families Across California and Texas',
    body: 'Baldwin Insurance Agency works with families throughout California and Texas. Licensing and product availability vary by state — call and we\'ll tell you exactly what\'s available where you are.',
  },
} as const

/** Sitewide footer compliance line. Carries two unfilled license numbers. */
export const compliance =
  'Baldwin Insurance Agency. [[TK: CA individual license #]] · [[TK: TX individual license #]]. Products and availability vary by state. This site is for general information and is not an offer of coverage.'
